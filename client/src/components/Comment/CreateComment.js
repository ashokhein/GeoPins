...
import { CRAETE_COMMENT_MUTATION } from './../../graphql/mutations'
...
const CreateComment = ({ classes }) => {
  ...
  const handleSubmitComment = async () => {
    ...
    await client.request(CRAETE_COMMENT_MUTATION,variables)
  ...
  return (
    <>
      <form className={classes.form}>
        ...
        <InputBase className={classes.input} placeholder="Add Comment" multiline={true} value={comment} onChange={e => setComment(e.target.value)}/>
